      ...
      axios
        .post(`${API_URL}/players`, playerData, {
          headers: {
            ...
            Authorization: `Bearer ${getTokenFromLocalStorage(tokenContent)}`,
          },
        })
        .then((response) => {
          ...
          <Col span={24}>
            <Card title="Player Information" bordered={true}>
              <Spin spinning={playerLoading}>
               ...
               {loginInfo.roles.includes("ADMIN") &&  <Row>
                  <Col>
                    <Form.Item>
                      <Space>
                        ...
                        {!id && (
                          <Button htmlType="button" onClick={onResetPlayerForm}>
                            Reset
                          </Button>
                        )}

                        <Link className="text-decoration-none" to={"/players"}>
                          {" "}
                          Cancel
                        </Link>
                      </Space>
