...
export default function OverviewTab({
    ...
    } = useGetFixturesQuery({ tournamentId }, { skip: !isActive });

    const fixtures = fixturesData?.content || [];

    // Fetch top 5 scorers for the tournament
    const { data: topScorersData, isLoading: topScorersLoading } =
        useGetTopScorersQuery({ tournamentId, limit: 5 }, { skip: !isActive });

    const topScorers = topScorersData?.content || [];
                ...
                roundMatches.forEach((match) => {
                    ...
                    if (!teamStats[homeTeamId]) {
                        teamStats[homeTeamId] = {
                            teamId: homeTeamId,
                            teamName:
                                match.homeTeamName || `Team ${homeTeamId}`,
                            matchesPlayed: 0,
                            wins: 0,
                            draws: 0,
                            losses: 0,
                    ...
                    if (!teamStats[awayTeamId]) {
                        teamStats[awayTeamId] = {
                            teamId: awayTeamId,
                            teamName:
                                match.awayTeamName || `Team ${awayTeamId}`,
                            matchesPlayed: 0,
                            wins: 0,
                            draws: 0,
                            losses: 0,
                    ...
                    teamStats[homeTeamId].goalDifference =
                        teamStats[homeTeamId].goalsFor -
                        teamStats[homeTeamId].goalsAgainst;
                    ...
                    teamStats[awayTeamId].goalDifference =
                        teamStats[awayTeamId].goalsFor -
                        teamStats[awayTeamId].goalsAgainst;
    ...
    const allStandings = useMemo(() => {
        ...
        // Add group standings
        Object.values(groupStandingsMap).forEach(
            ({ groupName, roundName, standings }) => {
    ...
    const tournamentStats = useMemo(() => {
        ...
        return {
            totalRounds:
                tournamentStructure.totalRounds ||
                tournamentStructure.rounds.length,
            totalGroups,
    ...
    const standingsColumns = [
        ...
        },
        {
            ...
            align: "center" as const,
            render: (wins: number) => (
                <Text style={{ color: token.colorSuccess }}>{wins}</Text>
            ),
        },
        {
            title: "D",
        ...
        },
        {
            ...
            render: (losses: number) => (
                <Text style={{ color: token.colorError }}>{losses}</Text>
            ),
        },
        {
            title: "GF",
                ...
                <Empty
                    description={
                        <div>
                            ...
                            <br />
                            <Text type="secondary">
                                Create rounds and groups to see standings.
                            </Text>
                        </div>
                    }
                />
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                {/* Player Card with Overlay Stats */}
                                                <div
                                                    style={{
                                                        position: "relative",
                                                        width: "100%",
                                                ...
                                                >
                                                    ...
                                                    {/* Player Name & Position - Bottom Center */}
                                                    <div
                                                        style={{
                                                            display: "flex",
                                                            flexDirection:
                    ...
                    >
                        {sortedRounds.map((round) => {
                            const roundStandings =
                                standingsByRoundAndGroup[round.roundName];
                            if (
                                !roundStandings ||
                                Object.keys(roundStandings).length === 0
                            ) {
                                return null;
                            }
                                                              ...
                                                              <div className="standings-table-wrapper">
                                                                  <Table
                                                                      ...
                                                                      rowKey={(
                                                                          ...
                                                                          `${record.roundName}-${record.groupName}-${record.teamId}`
                                                                      }
                                                                      pagination={
                                                                          false
                                                                      }
                                                      ...
                                                      <div className="standings-table-wrapper">
                                                          <Table
                                                              ...
                                                              rowKey={(
                                                                  ...
                                                                  `${record.roundName}-${record.teamId}`
                                                              }
                                                              pagination={false}
                                                              size="middle"
                                                              style={{
